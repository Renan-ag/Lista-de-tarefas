	...
	<head>
		...
		<script>
            function editar(id, txt_tarefa){
                ...
                //Gerando o campo de texto do form
                ...
                //Gerando input ovulto para o ID
                let inputId = document.createElement('input')
                inputId.type = 'hidden'
                inputId.name = 'id'
                inputId.value = id
                
                //Gerando o button(submit) do form
                let button = document.createElement('button')
                button.type = 'submit'
                button.className = 'btn btn-info col-3'
                button.innerHTML = 'Atualizar'
                
                //Adicionado os elementos dentro do form
                form.appendChild(inputTarefa)
                form.appendChild(inputId)
                form.appendChild(button)  
                
                //Pegando a div Tarefa
                let tarefa = document.getElementById('tarefa_'+id)
                
                //Limpando conteudo
                tarefa.innerHTML = ''
                
                //Incluindo o form na pagina
